...
public class Practice12Test {
    ...
    public void should_teacher_have_name_and_age_and_classes() throws Exception {
        LinkedList<practice12.Klass> linkedList = new LinkedList<Klass>();
    ...
    @Test
    public void should_computer_be_nofified() throws Exception {
        LinkedList<practice12.Klass> linkedList = new LinkedList<Klass>();
        linkedList.add(klass2);

        Computer computer = new Computer(linkedList);
        Student jerry = new Student(1, "Jerry", 8, new Klass(3));
        klass2.appendMember(jerry);

        assertThat(systemOut().endsWith("I am the Machine. I know Jerry has joined Class 2.\n"));
    }
}
